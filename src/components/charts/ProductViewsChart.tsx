...
interface IProductViewsChart {
  productId: number;
}

const ProductViewsChart: React.FC<IProductViewsChart> = ({ productId }) => {
  ...
  return (
    <Card title="Biểu đồ Lượt Xem Sản Phẩm" style={{ margin: "0 auto" }}>
