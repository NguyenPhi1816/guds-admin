...
interface IProductFavoritesChart {
  productId: number;
}

const ProductFavoritesChart: React.FC<IProductFavoritesChart> = ({
  productId,
}) => {
  ...
  useEffect(() => {
    async function fetcher() {
      if (dateRange && dateRange[0] && dateRange[1]) {
        ...
        const options = {
          title: {
            text: "Số lượt thêm sản phẩm vào danh sách yêu thích",
            left: "center",
          },
          tooltip: {
            trigger: "axis",
  ...
  return (
    <Card
      title="Biểu đồ Lượt Thêm Sản Phẩm Vào Danh Sách Yêu Thích"
      style={{ margin: "0 auto" }}
    >
...
export default ProductFavoritesChart;
